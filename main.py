...
label1.place(x=0,y=0,width=1172,height=57)
...
"Roll No", "Name", "Mobile No", "Email id", "Address", "Gender", "D.O.B", "SSC Result", "HSC Result", "Branch", "Sem 1",
"Sem 2", "Sem 3", "Sem 4", "Sem 5", "Sem 6", "Sem 7", "Sem 8"),yscrollcommand=scroll_y.set,xscrollcommand=scroll_x.set)
...
studenttable.column('Mobile No', width=80)
...
SliderLabel = Label(root,text = ss,font = ('Times',25,'bold'),relief = RIDGE, borderwidth  =0 ,width = 55,bg = 'white',bd=2,highlightbackground="light blue")
...
def addstudent():
    ...
    def submit():
        ...
        details = (RollNo,Name,MobileNo,Emailid,Address,Gender,DOB,SSCResult,HSCResult,Branch,Sem1,Sem2,Sem3,Sem4,Sem5,Sem6,Sem7,Sem8)
        import pymysql
        try :
            if (len(MobileNo)==10 or MobileNo==""):
                ...
                if ((re.match(r"[^@]+@[^@]+\.[^@]+", Emailid))or Emailid==""):
                    ...
                    if SSCResult >= 0 and SSCResult <= 100 or SSCResult=="0":
                                                    ...
                                                    if Sem7 >= 0 and Sem7 <= 100 or Sem7 == "0":
                                                        ...
                                                        if Sem8 >= 0 and Sem8 <= 100 or Sem8 == "0":
                                                            ...
                                                            try:
                                                                ...
                                                                print("hello")
                                                                cursor.execute(str, (
                                                                    RollNo, Name, MobileNo, Emailid, Address, Gender,
                        ...
                        messagebox.showerror('Notifications', 'Invalid Percentage of SSC !\nPlease Enter Correct Percentage',
                                             parent=addroot)
                        sscval.set('0')
    ...
    dobentry = DateEntry(addroot, font=("Times", 16),background="black", disabledbackground="black", bordercolor="black",headersbackground="black", normalbackground="white", foreground='black',normalforeground='black', headersforeground='black', bd=0, textvariable=dobval, selectmode='day')
...
def Connectdatabase():
    global mycursor, con
    try:
        con = pymysql.connect(host="localhost", user="root",database='studentmanagementsystem1', password="Rohit@9324")
        mycursor = con.cursor()
        print("Connected")
    except:
...
def searchstudent():
    def search():
        ...
        if (RollNo != ''):
            ...
            studenttable.delete(*studenttable.get_children())
            for i in datas:
                vv = [i[0], i[1],i[2], i[3], i[4], i[5], i[6],i[7],i[8],i[9],i[10],i[11],i[12],i[13],i[14],i[15],i[16],i[17]]
                studenttable.insert('', END, values=vv)
    ...
    idlabel = Label(searchroot, text="Gender : ", bg="white smoke", font=("Times", 15), bd=0, relief=GROOVE,
                    borderwidth=2, width=10)
    idlabel.place(x=10, y=310)
    idlabel = Label(searchroot, text="Date Of Birth : ", bg="white smoke", font=("Times", 15), bd=0, relief=GROOVE,
                    borderwidth=2, width=14)
    idlabel.place(x=10, y=370)
...
def deletetudent():
    ...
    pp = content['values'][0]
    res = messagebox.askyesnocancel('Notifications','Do You Want To Delete {} Details Permanently ?'.format(pp))
    if(res==True):
...
def updatestudent():
    ...
    idlabel = Label(updateroot, text="Gender : ", bg="white smoke", font=("Times", 15), bd=0, relief=GROOVE,
                    borderwidth=2, width=10)
    idlabel.place(x=10, y=310)
    idlabel = Label(updateroot, text="Date Of Birth : ", bg="white smoke", font=("Times", 15), bd=0, relief=GROOVE,
                    borderwidth=2, width=14)
    idlabel.place(x=10, y=370)
    ...
    dobentry = Entry(updateroot, font=("Times", 14), bd=1, textvariable=dobval, highlightthickness=1)
    dobentry.place(x=160, y=370)
...
def exportstudent():
    ...
    for i in gg:
        ...
        pp = content["values"]
        print("hello")
        Rollno.append(pp[0]),Name.append(pp[1]),Mobileno.append(pp[2]),Emailid.append(pp[3]),Address.append(pp[4]),Gender.append(pp[5]),DOB.append(pp[6]),SSCResult.append(pp[7]),HSCResult.append(pp[8]),Branch.append(pp[9]),Sem1.append(pp[10]),Sem2.append(pp[11]),Sem3.append(pp[12]),Sem4.append(pp[13]),Sem5.append(pp[14]),Sem6.append(pp[15]),Sem7.append(pp[16]),Sem8.append(pp[17])
        dd =["Roll No","Name","Mobile No","Email id","Address","Gender","D.O.B","SSC Result","HSC Result","Branch","Sem 1","Sem 2","Sem 3", "Sem 4", "Sem 5", "Sem 6", "Sem 7", "Sem 8"]
        df=pandas.DataFrame(list(zip(Rollno,Name,Mobileno,Emailid,Address,Gender,DOB,SSCResult,HSCResult,Branch,Sem1,Sem2,Sem3,Sem4,Sem5,Sem6,Sem7,Sem8)),columns=dd)
        print("hello")
        print(df)
...
addbtn = Button(DataEntryFrame1,text = 'Add Student',font=("roman",15,"bold"),width = 32,bd=1,highlightthickness=0,bg="white",highlightcolor="white",command=addstudent)
addbtn.pack(side = TOP,expand=TRUE)
searchbtn = Button(DataEntryFrame1,text = 'Search Student',width = 32, font=('roman',15,'bold'),bg = 'white',borderwidth=1,bd= 0,command=searchstudent)
searchbtn.pack(side=TOP,expand=TRUE)
delbtn = Button(DataEntryFrame1,text = 'Delete Student',width = 32, font=('roman',15,'bold'),bg = 'white',borderwidth=1,bd= 0,command=deletetudent)
delbtn.pack(side=TOP,expand=TRUE)
updatebtn = Button(DataEntryFrame1,text = 'Update Student',width = 32, font=('roman',15,'bold'),bg = 'white',borderwidth=1,bd= 0,command=updatestudent)
updatebtn.pack(side=TOP,expand=TRUE)
showbtn = Button(DataEntryFrame1,text = 'Show All',width = 32, font=('roman',15,'bold'),bg = 'white',bd= 0,borderwidth=1,command=showstudent)
showbtn.pack(side=TOP,expand=TRUE)
exportbtn = Button(DataEntryFrame1,text = 'Export Data',width = 32, font=('roman',15,'bold'),bg = 'white',borderwidth=1,bd= 0,command=exportstudent)
exportbtn.pack(side=TOP,expand=TRUE)
exitbtn = Button(DataEntryFrame1,text = 'Exit',width = 32,borderwidth=1,font=('roman',15,'bold'),bg = "white",bd= 0,command=exitstudent)
